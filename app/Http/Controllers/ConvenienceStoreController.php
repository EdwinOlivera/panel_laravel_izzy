<?php
/**
 * File name: ConvenienceStoreController.php
...
use App\DataTables\ConvenienceStoreDataTable;
...
class ConvenienceStoreController extends Controller
{
     ...
     *
     * @param ConvenienceStoreDataTable $convenienceStoreDataTable
     * @return Response
     */
    public function index(ConvenienceStoreDataTable $convenienceStoreDataTable)
    {
        return $convenienceStoreDataTable->render('convenience_stores.index');
    }
    ...
    public function create()
    {
        ...
        $typeMarket = $this->typeMarketRepository->where('id','=','2')->pluck('name', 'id');
        $usersSelected = [];
        $driversSelected = [];
        $fieldsSelected = [];
        ...
        return view('convenience_stores.create')->with("customFields", isset($html) ? $html : false)->with("typeMarket", $typeMarket)->with("user", $user)->with("drivers", $drivers)->with("usersSelected", $usersSelected)->with("driversSelected", $driversSelected)->with('field', $field)->with('fieldsSelected', $fieldsSelected);
    }
    ...
    public function store(CreateMarketRequest $request)
    {
        ...
        Flash::success(__('lang.saved_successfully', ['operator' => __('lang.convenience_store')]));
    ...
    public function show($id)
    {
        ...
        return view('convenience_stores.show')->with('market', $market);
    }
    ...
    public function edit($id)
    {
        ...
        return view('convenience_stores.edit')->with('market', $market)->with("typeMarket", $typeMarket)->with("customFields", isset($html) ? $html : false)->with("user", $user)->with("drivers", $drivers)->with("usersSelected", $usersSelected)->with("driversSelected", $driversSelected)->with('field', $field)->with('fieldsSelected', $fieldsSelected);
    }
    ...
    public function editCategory($id)
    {
        ...
        return view('convenience_stores.edit_convenience_store_complete')->with('market', $market)->with('categoriesProducts', $categoriesProducts);
    }
    ...
    public function update($id, UpdateMarketRequest $request)
    {
        ...
        Flash::success(__('lang.updated_successfully', ['operator' => __('lang.convenience_store')]));
    ...
    public function destroy($id)
    {
        if (!env('APP_DEMO', false)) {
            ...
            Flash::success(__('lang.deleted_successfully', ['operator' => __('lang.convenience_store')]));
        } else {
     ...
     * @throws \Prettus\Repository\Exceptions\RepositoryException
     */
    public function editSectionsByConvenienceStore($id)
    {
        $this->marketRepository->pushCriteria(new MarketsOfUserCriteria(auth()->id()));
        $market = $this->marketRepository->findWithoutFail($id);
        ...
        return view('convenience_stores.edit_sections')->with('market', $market);
    }
}
