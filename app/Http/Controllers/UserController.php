...
class UserController extends Controller
{
        ...
        try {
            ...
            if(isset($input['roles'][0]) && $input['roles'][0]){
                if( $input['roles'][0] == 'admin')
                    $input['isAdmin'] = 1;
            }elseif(isset($input['roles'][1]) && $input['roles'][1]){
                if( $input['roles'][1] == 'admin')
                    $input['isAdmin'] = 1;
            }elseif(isset($input['roles'][2]) && $input['roles'][2]){
                if( $input['roles'][2] == 'admin')
                    $input['isAdmin'] = 1;
            }elseif(isset($input['roles'][3]) && $input['roles'][3]){
                if( $input['roles'][3] == 'admin')
                    $input['isAdmin'] = 1;
            }elseif(isset($input['roles'][4]) && $input['roles'][4]){
                if( $input['roles'][4] == 'admin')
                    $input['isAdmin'] = 1;
            }else{
                $input['isAdmin'] = 0;
    ...
    public function terms_conditions(){
        return view('privacy.terms_conditions');
