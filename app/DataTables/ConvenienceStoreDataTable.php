<?php
/**
 * File name: ConvenienceStoreDataTable.php
...
class ConvenienceStoreDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->addColumn('action', 'convenience_stores.datatables_actions')
    ...
    public function query(Market $model)
    {
        if (auth()->user()->hasRole('admin')) {
            ...
            return $model->where('type_market_id', '=', '2');
