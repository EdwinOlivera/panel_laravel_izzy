...
@can('fields.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('fields*') ? 'active' : '' }}" href="{!!  route('fields.index') !!}">
            @if ($icons)<i class="nav-icon fa fa-tasks"></i>@endif
            <p>{{ trans('Categ. Establecimientos') }}</p>
        </a>
    </li>
@endcan
...
@can('markets.index')
    <li
        class="nav-item has-treeview {{ (Request::is('markets*') || Request::is('requestedMarkets*') || Request::is('typesMarket*') || Request::is('galleries*') || Request::is('marketReviews*')) && !Request::is('marketsPayouts*') ? 'menu-open' : '' }}">
        <a href="#"
            class="nav-link {{ (Request::is('markets*') || Request::is('requestedMarkets*') || Request::is('typesMarket*') || Request::is('galleries*') || Request::is('marketReviews*')) && !Request::is('marketsPayouts*') ? 'active' : '' }}">
            @if ($icons)
        ...
        <ul class="nav nav-treeview">
            @can('markets.index')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('markets*') ? 'active' : '' }}" href="{!!  route('markets.index') !!}">
                        @if ($icons)
            ...
            @can('typesMarket.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('typesMarket*') ? 'active' : '' }}"
                        href="{!!  route('typesMarket.index') !!}">
                        @if ($icons)
                            <i class="nav-icon fa fa-object-group"></i>
                        @endif
                        <p>{{ trans('Tipos de Establecimientos') }}</p>
                    </a>
                </li>
            @endcan
...
@can('markets.index')
    <li class="nav-item has-treeview {{ Request::is('supermarkets*') ||Request::is('departments*') ||Request::is('subdepartments*')  ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('supermarkets*') ||Request::is('departments*') ||Request::is('subdepartments*')  ? 'active' : '' }}">
            @if ($icons)
                <i class="nav-icon fa fa-store-alt"></i>
            @endif
            <p>{{ trans('Supermercados') }} <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('supermarkets.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('supermarkets*') ? 'active' : '' }}"
                        href="{!!  route('supermarkets.index') !!}">
                        @if ($icons)
                            <i class="nav-icon fa fa-store-alt"></i>
                        @endif
                        <p>{{ trans('Supermercados') }}</p>
                    </a>
                </li>
            @endcan
            @can('departments.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('departments*') ? 'active' : '' }}"
                        ...
                        @endif
                        <p>{{ trans('Departamentos') }}</p>
                    </a>
                </li>
            @endcan
            @can('subdepartments.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('subdepartments*') ? 'active' : '' }}"
                        href="{!!  route('subdepartments.index') !!}">
                        @if ($icons)
                            <i class="nav-icon fa fa-tags"></i>
                        @endif
                        <p>{{ trans('Subdepartamentos') }}</p>
                    </a>
                </li>
            @endcan
        </ul>
...
@can('markets.index')
    <li class="nav-item has-treeview {{ Request::is('convenience_stores*') || Request::is('sections*')   ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('convenience_stores*') || Request::is('sections*')   ? 'active' : '' }}">
            @if ($icons)
                <i class="nav-icon fa fa-store"></i>
            @endif
            <p>{{ trans('Tnds. de conveniencia') }} <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('convenience_stores.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('convenience_stores*') ? 'active' : '' }}"
                        href="{!!  route('convenience_stores.index') !!}">
                        @if ($icons)
                            <i class="nav-icon fa fa-store-alt"></i>
                        @endif
                        <p>{{ trans('Tiendas de conveniencia') }}</p>
                    </a>
                </li>
            @endcan
            @can('sections.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('sections*') ? 'active' : '' }}"
                        ...
                        @if ($icons)
                            <i class="nav-icon fa fa-grip-lines"></i>
                        @endif
                        <p>{{ trans('Secciones') }}</p>
                    </a>
                </li>
...
@can('products.index')
    <li
        ...
        <a href="#"
            class="nav-link {{ Request::is('products*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'active' : '' }}">
            @if ($icons)
            ...
            @can('optionGroups.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('optionGroups*') ? 'active' : '' }}"
                        href="{!!  route('optionGroups.index') !!}">
                        @if ($icons)<i class="nav-icon fa fa-plus-square"></i>@endif
                        <p>{{ trans('lang.option_group_plural') }}</p>
                    </a>
                </li>
            @endcan
            @can('options.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('options*') ? 'active' : '' }}" href="{!!  route('options.index') !!}">
                        @if ($icons)
                            <i class="nav-icon fa fa-plus-square-o"></i>
                        @endif
                        <p>{{ trans('lang.option_plural') }}</p>
                    </a>
                </li>
            @endcan
            ...
            @can('productReviews.index')
                {{-- <li class="nav-item">
                    <a class="nav-link {{ Request::is('productReviews*') ? 'active' : '' }}"
                        ...
                        @endif
                        <p>{{ trans('lang.product_review_plural') }}</p>
                    </a>
                </li> --}}
            @endcan
            ...
            @can('orderStatuses.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('orderStatuses*') ? 'active' : '' }}"
                        ...
                        @endif
                        <p>{{ trans('lang.order_status_plural') }}</p>
                    </a>
                </li>
            @endcan
            ...
            @can('deliveryAddresses.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('deliveryAddresses*') ? 'active' : '' }}"
                        href="{!!  route('deliveryAddresses.index') !!}">
                        @if ($icons)<i class="nav-icon fa fa-map"></i>@endif
                        <p>{{ trans('lang.delivery_address_plural') }}</p>
                    </a>
                </li>
            @endcan
...
@can('encargos.index')
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('encargos*') ? 'active' : '' }}" href="{!!  route('encargos.index') !!}">
            @if ($icons)<i class="nav-icon fa fa-map-signs"></i>@endif
            <p>Mandaditos</p>
        </a>
    </li>
@endcan
...
@can('drivers.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('drivers*') ? 'active' : '' }}" href="{!!  route('drivers.index') !!}">
            @if ($icons)<i class="nav-icon fa fa-car"></i>@endif
...
@can('payments.index')
    <li
        class="nav-item has-treeview {{ Request::is('earnings*') || Request::is('driversPayouts*') || Request::is('marketsPayouts*') || Request::is('payments*') ? 'menu-open' : '' }}">
        <a href="#"
            class="nav-link {{ Request::is('earnings*') || Request::is('driversPayouts*') || Request::is('marketsPayouts*') || Request::is('payments*') ? 'active' : '' }}">
            @if ($icons)
        ...
        <ul class="nav nav-treeview">
            ...
            @can('driversPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('driversPayouts*') ? 'active' : '' }}"
                        href="{!!  route('driversPayouts.index') !!}">
            ...
            @can('marketsPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('marketsPayouts*') ? 'active' : '' }}"
                        href="{!!  route('marketsPayouts.index') !!}">
                        @if ($icons)<i class="nav-icon fa fa-dollar"></i>@endif
                ...
                {{-- <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('settings/permissions') ? 'active' : '' }}"
                            ...
                            @if ($icons)<i class="nav-icon fa fa-circle-o"></i>
                            @endif
