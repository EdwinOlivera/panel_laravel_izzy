    ...
    <div class="row">
        <div class="marco_decorativo justify-content-center col-3 py-2">
            ...
            <div class=" ">
                ...
                <a href="#" data-placement="bottom" title="{{ trans('Crear y añadir una Categoria nueva') }}"
                ...
                <a href="#" id="mSeleccionarCategorias" data-placement="bottom"
                ...
                @foreach ($categoriesProducts as $category)
                    <li class="list-group-item  btn btn-success item "
                        ...
                        @can('categories.destroy')
                            <a href="#" class="pr-2" onClick="removeCategoryFromMarket({{ $category->id }})"
                        ...
                        @can('categories.edit')
                            <a href="#" data-toggle="modal" title="{{ trans('Editar esta categoria') }}"
        ...
        function getProduct(idCategory, idProduct) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    <a href="#" id="IDProductosParaAgregar" onClick="AgregarProductos(${idCategory})" class="CuartoDeCentrado" data-placement="bottom" title="{{ trans('Añadir productos existente') }}" style="color: black"  >
                        <i class="fa fa-plus-square cruz_cuadrado"  ></i>  
                    </a>
            `;
                    if ((res).length > 0) {
                                ...
                                document.getElementById('sort_products_sort').innerHTML += `
                                    <li class="list-group-item  btn btn-success item" id='${product['id']}'  data-id="${product['id']}">
                                        @can('products.destroy')    
                                                <a href="#" onClick="removeProductsFromCategory(${product['id']},${idCategory})" title="{{ trans('Eliminar de la categoria actual') }}">
                                                    <i class="fa fa-minus-circle text-danger" ></i>
                                                </a>
                                        @endcan
                                        ...
                                        @can('products.destroy')
                                                ...
                                                <a href="#" onClick="cambiarDisponibilidad(${product['id']},${product['featured']},${idCategory})">
                                                    <i class="fa fa-low-vision btn btn-link text-danger"></i>
                                                </a>
                                        @endcan
                                    </li>
        ...
        function getOptionGroupByProduct(idProduct, idGrupoRec) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    <a href="#" style="color: black" onClick="selectIdProduct(${idProduct})" class="CuartoDeCentrado"  title="{{ trans('Crear y añadir un nuevo Grupo de Opciones') }}" data-toggle="modal" data-target="#ModalCreatGrupoOpcion">
                        <i class="fa fa-plus-circle cruz_circulo" ></i>
                    </a>

                    <a href="#" id="mSeleccionarCategorias" onClick="AgregarGrupoOpciones(${idProduct})" class="CuartoDeCentrado" data-placement="bottom" title="{{ trans('Añadir Grupos existente') }}" style="color: black"  >
                        <i class="fa fa-plus-square cruz_cuadrado"  ></i>  
                    </a>
                    `;
                    if ((res).length > 0) {
                    ...
                    `;
                        ...
                        <li  class="list-group-item  btn btn-success item"id="${grupoOpcion['id']}_grupoOpcion"  data-id="${grupoOpcion['id']}_grupoOpcion">
                            ...
                            @endcan
                                <span class="textoNombre col-8" onClick="selectGrupoOpcionList('${grupoOpcion['id']}_grupoOpcion',${res.length},${grupoOpcion['id']},${grupoOpcion['id_producto']})">
                                    ${grupoOpcion['name']}
                                </span>
                            <span class="handle ">
                                <i class="fa fa-sort"></i>
                            ...
                            @can('products.edit')
                                    ...
                                    <a href="#"  onClick="selectIdProductUpdate(${idProduct},${grupoOpcion['id']},'${grupoOpcion['name']}', '${grupoOpcion['name_admin']}',${grupoOpcion['cant_selectable']},${grupoOpcion['active']}, ${grupoOpcion['multi']},${grupoOpcion['force_select']})" data-toggle="modal" data-target="#ModalUpdateGrupoOpcion" >
                                        <i class="fa fa-edit"></i>
                                    </a>
                            @endcan
                            @can('optionGroups.destroy')

                                    <a href="#" onClick="alternarActivacionGrupoOpciones(${idProduct},${grupoOpcion['id']},'${grupoOpcion['name']}', '${grupoOpcion['name_admin']}',${grupoOpcion['cant_selectable']},${grupoOpcion['active']}, ${grupoOpcion['multi']},${grupoOpcion['force_select']})">
                                        <i class="fa fa-low-vision btn btn-link text-danger"></i>
                                    </a>
                            @endcan
                        </li> 
                    ...
                    `;
                        ...
                        <li  class="list-group-item  btn btn-success item  "id="${grupoOpcion['id']}_grupoOpcion"  data-id="${grupoOpcion['id']}_grupoOpcion">
                            ...
                            @endcan
                                <span class="textoNombre col-8 desactivado" onClick="selectGrupoOpcionList('${grupoOpcion['id']}_grupoOpcion',${res.length},${grupoOpcion['id']},${grupoOpcion['id_producto']})">
                                    ${grupoOpcion['name']}
                                </span>
                            <span class="handle ">
                                <i class="fa fa-sort"></i>
        ...
        function getOptions(idGrupoOpcion, idProducto, IdOpcionUpdate) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    <a href="#" style="color: black" onClick="selectIdGrupoOpcion(${idGrupoOpcion}, ${idProducto})" title="{{ trans('Crear y añadir un nueva Opción') }}" class="CuartoDeCentrado" data-toggle="modal" data-target="#ModalCreateOpcion">
                        <i class="fa fa-plus-circle cruz_circulo"  ></i>
                    </a>
                    <a href="#" id="mSeleccionarCategorias" onClick="AgregarOpciones(${idGrupoOpcion},${idProducto})" class="CuartoDeCentrado" data-placement="bottom" title="{{ trans('Añadir productos existente') }}" style="color: black"  >
                        <i class="fa fa-plus-square cruz_cuadrado"  ></i>  
                    </a>
                    `;
                    if ((res).length > 0) {
                    ...
                    `;
                        ...
                        <li  class="list-group-item   "id="${opciones['id']}_opciones" onClick="selectOpcion('${opciones['id']}_opciones',${res.length})" data-id="${opciones['id']}_opciones">
                            @can('options.destroy')    
                                    <a href="#" onClick="removeFromOptiongGroup(${opciones['id']},${idProducto},${idGrupoOpcion})">
                                        <i class="fa fa-minus-circle text-danger"></i>
                                    </a>
                            @endcan
                            ...
                            <span class="handle ">
                                ...
                                @can('products.edit')
                                    ...
                                    <a href="#"  onClick="selectIdGrupoOpcionUpdate(${idGrupoOpcion},${opciones['product_id']},${opciones['id']},'${opciones['name']}',${opciones['price']},${opciones['active']})" data-toggle="modal" data-target="#ModalUpdateOpcion" >
                                        <i class="fa fa-edit"></i>
                                    </a>
                            @endcan
                            @can('products.destroy')

                                    <a href="#" onClick="alternarActivacionOpcion(${idGrupoOpcion},${opciones['product_id']},${opciones['id']},'${opciones['name']}',${opciones['price']},${opciones['active']})">
                                        <i class="fa fa-low-vision btn btn-link text-danger"></i>
                                    </a>
                            @endcan
                        </li> 
