...
<!-- Price Field -->
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.product_price_placeholder"),'step'=>"any", 'min'=>"0", 'value = 1']) !!}
            <div class="form-text text-muted">
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Sections Id Field -->
    <div class="form-group row ">
        {!! Form::label('sections[]', trans("Secciones"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('sections[]', $sections, $sectionsSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("Secciones de la tienda de conveniencia asociadas") }}</div>
        </div>
    </div>
    @endif
    ...
    <div class="form-group row ">
        {!! Form::label('featured_label', trans("Disponible"),['class' => 'col-3 control-label text-right']) !!}
    ...
    <div class="form-group row ">
        {!! Form::label('deliverable_label', trans("lang.product_deliverable"),['class' => 'col-3 control-label text-right']) !!}
        <div class="checkbox icheck">
            <label class="col-9 ml-2 form-check-inline">
...
<div class="form-group col-12 text-right">
    ...
    <a href="{!! route('convenience_stores.editSectionsByConvenienceStore',$idMarket) !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
