...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        {!! Form::label('subdepartments[]', trans("lang.subdepartment"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('subdepartments[]', $subparments, $subparmentsSelected, ['class' => 'select2 form-control', 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.product_category_id_help") }}</div>
        </div>
    </div>
    @endif
...
<div class="form-group col-12 text-right">
    ...
    <a href="{!! route('supermarkets.editDepartmentsByMarket',$idMarket) !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
