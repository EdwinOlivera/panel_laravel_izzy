...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        {!! Form::label('name', trans('lang.section_name'), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' =>
            trans('lang.section_name_placeholder')]) !!}
            <div class="form-text text-muted">
                {{ trans('lang.section_name_help') }}
            </div>
        </div>
    ...
    <!-- Description Field -->
    <div class="form-group row ">
        {!! Form::label('description', trans('lang.section_description'), ['class' => 'col-3 control-label
        text-right']) !!}
        <div class="col-9">
            {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' =>
            trans('lang.section_description_placeholder')]) !!}
            <div class="form-text text-muted">{{ trans('lang.section_description_help') }}</div>
        </div>
    </div>
    
    <!-- Image Field -->
    {{-- <div class="form-group row">
        {!! Form::label('image', trans('lang.section_image'), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Markets Id Field -->
    <div class="form-group row ">
        {!! Form::label('markets[]', trans('lang.section_market_id'), ['class' => 'col-3 control-label text-right'])
        !!}
        <div class="col-9">
            {!! Form::select('markets[]', $markets, $marketsSelected, ['class' => 'select2 form-control','multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans('lang.section_market_id_help') }}</div>
        </div>
    </div>
    <div class="form-group row ">
...
<div class="form-group col-12 text-right">
    <button type="submit" class="btn btn-{{ setting('theme_color') }}"><i class="fa fa-save"></i>
        {{ trans('lang.save') }} {{ trans('lang.section') }}</button>
    <a href="{!!  route('sections.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>
        {{ trans('lang.cancel') }}</a>
</div>
