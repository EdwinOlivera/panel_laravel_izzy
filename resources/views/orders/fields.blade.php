...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::select('driver_id', $driver, null, ['data-empty' => trans('lang.order_driver_id_placeholder'),
    ...
    <div class="form-group row ">
        {!! Form::label('order_status_id', trans('lang.order_order_status_id'), ['class' => 'col-3 control-label
        text-right']) !!}
        <div class="col-9">
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::number('tax', null, ['class' => 'form-control', 'step' => 'any', 'placeholder' =>
            trans('lang.order_tax_placeholder')]) !!}
    ...
    <div class="form-group row ">
        ...
        !!}
        <div class="col-9">
            {!! Form::number('delivery_fee', null, ['class' => 'form-control', 'step' => 'any', 'placeholder' =>
            trans('lang.order_delivery_fee_placeholder')]) !!}
            <div class="form-text text-muted">
    ...
    <!-- mapa_fechas_cambio Field -->
    {!! Form::hidden('mapa_fechas_cambio', null) !!}
{{-- Propiedad oculpa para su posterior modificacion por parte del sistema --}}
{{-- Se actualizara la fecha de cuando se hizo el ultimo cambio resepctivo --}}
...
<div class="form-group col-12 text-right">
    <button type="submit" class="btn btn-{{ setting('theme_color') }}"><i class="fa fa-save"></i>
        {{ trans('lang.save') }} {{ trans('lang.order') }}</button>
    <a href="{!!  route('orders.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>
        {{ trans('lang.cancel') }}</a>
</div>
