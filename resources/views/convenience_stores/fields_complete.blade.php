                        ...
                        <li  class="list-group-item   "id="${opciones['id']}_opciones" onClick="selectOpcion('${opciones['id']}_opciones',${res.length})" data-id="${opciones['id']}_opciones">
                            ...
                            <span class="handle ">
                                ...
                                @can('products.edit')
                                    ...
                                    <a href="#"  onClick="selectIdGrupoOpcionUpdate(${idGrupoOpcion},${idProducto},${opciones['id']},'${opciones['name']}',${opciones['price']},${opciones['active']})" data-toggle="modal" data-target="#ModalUpdateOpcion" >
                                        <i class="fa fa-edit"></i>
                                    </a>
                            @endcan
                            @can('products.destroy')

                                    <a href="#" onClick="alternarActivacionOpcion(${idGrupoOpcion},${idProducto},${opciones['id']},'${opciones['name']}',${opciones['price']},${opciones['active']})">
                                        <i class="fa fa-low-vision btn btn-link text-danger"></i>
                                    </a>
                            @endcan
                        </li> 
