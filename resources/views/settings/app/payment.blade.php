    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                ...
                {{-- enable_pixelpay --}}
                <li class="nav-item">
                    <a class="nav-link" href="{!! url('settings/payment/pixelpay') !!}"><i class="fa fa-envelope-o mr-2"></i>{{trans('lang.app_setting_pixelpay')}}@if(setting('enable_pixelpay',false))<span class="badge ml-2 badge-success">{{trans('lang.active')}}</span>@endif
                    </a>
                </li>
