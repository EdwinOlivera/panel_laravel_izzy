...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        {!! Form::label('name', trans('lang.subdepartment_name'), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' =>
            trans('lang.subdepartment_name_placeholder')]) !!}
    ...
    <!-- Image Field -->
    <div class="form-group row">
        {!! Form::label('image', trans('lang.subdepartment_image'), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            ...
            <div class="form-text text-muted w-50">
                {{ trans('lang.subdepartment_image_help') }}
            </div>
        </div>
    </div>
    @prepend('scripts')
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Department Id Field -->
    <div class="form-group row ">
        {!! Form::label('departments[]', trans('lang.department_id'), ['class' => 'col-3 control-label text-right'])
        !!}
        <div class="col-9">
            {!! Form::select('departments[]', $departments, $departmentsSelected, ['class' => 'select2 form-control','multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans('lang.department_id_help') }}</div>
        </div>
    </div>
    <!-- Description Field -->
    <div class="form-group row ">
        {!! Form::label('description', trans('lang.subdepartment_description'), ['class' => 'col-3 control-label
        text-right']) !!}
        <div class="col-9">
            {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' =>
            trans('lang.subdepartment_description_placeholder')]) !!}
...
<div class="form-group col-12 text-right">
    <button type="submit" class="btn btn-{{ setting('theme_color') }}"><i class="fa fa-save"></i>
        {{ trans('lang.save') }} {{ trans('lang.subdepartment') }}</button>
    <a href="{!!  route('subdepartments.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i>
        {{ trans('lang.cancel') }}</a>
</div>
